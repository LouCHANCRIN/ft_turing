...
from utils.error import ParsingError, MachineError
...
def get_input():
    ...
    parser.add_argument("--universal", dest="universal", action=argparse.BooleanOptionalAction, help="Used to compute universal machine", type=bool, default=False)
